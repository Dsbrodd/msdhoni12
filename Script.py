class script(object):
    START_TXT = """𝙷𝙴𝙻𝙾 {},
<b>Sᴏʀʀʏ ɪ ᴏɴʟʏ ᴡᴏʀᴋ ᴏɴ ғɪʟᴍ ʜᴏᴜꜱᴇ Gʀᴏᴜᴘ. Nᴏ ᴏᴛʜᴇʀ ᴄᴏᴍᴍᴀɴᴅ ᴡɪʟʟ ᴡᴏʀᴋ ᴏɴ ᴛʜɪs ʙᴏᴛ ᴇxᴄᴇᴘᴛ sᴛᴀʀᴛ. ᴅᴏɴ’ᴛ ᴡᴀsᴛᴇ ʏᴏᴜʀ ᴛɪᴍᴇ</b>"""
    HELP_TXT = """𝙷𝙴𝚈 {}
<b>എന്നെ നിർമിച്ചിരിക്കുന്നത് <a href=https://t.me/Film_housc>ғɪʟᴍ ʜᴏᴜꜱ</a> ഗ്രൂപ്പിലേക്ക് ആണ്.
